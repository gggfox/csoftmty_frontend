    ...
    <Flex bg="white_dark" h='100%' flexDirection="column">
      ...
      <Grid
        ...
        >
          ...
          <Image src="https://images.pexels.com/photos/97077/pexels-photo-97077.jpeg" alt="logo" width="100%" height="100vh" />
          </GridItem>
          ...
          <GridItem rowSpan={6} colSpan={36} rowStart={5} colStart={6}>
                ...
                <Heading h="100%" color="white_light" fontWeight="bold" fontFamily="lato" fontSize={lg_txt} align="center" textShadow="1px 1px orange">
          ...
          <GridItem rowSpan={3} colSpan={26} rowStart={11} colStart={10}>
              <Flex flexDirection="column" justifyContent="center" alignItems="center">
            <Button backgroundColor="#ffffff00" borderRadius={0} borderWidth={5} p={6} color="white_light" _hover={{color:"gray_dark", backgroundColor:"white_light"}}>
              Pagame perro
              </Button>
            </Flex>
          </GridItem>
